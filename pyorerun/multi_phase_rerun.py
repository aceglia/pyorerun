...
class MultiPhaseRerun:
    ...
    def update_animated_model(self, biomod: BiorbdModel, q: np.ndarray, phase: int = 0, window: str = "animation") -> None:
        self.rerun_biorbd_phases[phase][window].update_animated_model(biomod, q)
